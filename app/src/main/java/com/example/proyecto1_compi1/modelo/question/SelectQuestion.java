...
public class SelectQuestion extends QuestionModel {
    ...
    private ArrayList<String> optionsPoke = null;
        ...
        switch (prop.getKey()) {
            ...
            case "options_poke":
                if (prop.getValue() instanceof ArrayList) {
                    ...
                    android.util.Log.d("SelectQuestion",
    ...
    public void resolvePokeApi() {
        ...
        try {
            ...
            android.util.Log.e("SelectQuestion",
    ...
    public ArrayList<String> getOptions() {
        if (needsPokeApiResolution()) {
            android.util.Log.w("SelectQuestion",
