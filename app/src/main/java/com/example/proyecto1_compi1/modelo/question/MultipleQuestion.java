...
public class MultipleQuestion extends QuestionModel {
    ...
    private ArrayList<String> optionsPoke = null; // parámetros PokeAPI
        ...
        switch (prop.getKey()) {
            ...
            case "options_poke":
                if (prop.getValue() instanceof ArrayList) {
                    ...
                    android.util.Log.d("MultipleQuestion",
    ...
    public void resolvePokeApi() {
        ...
        try {
            ...
            android.util.Log.e("MultipleQuestion",
    ...
    public ArrayList<String> getOptions() {
        if (needsPokeApiResolution()) {
            android.util.Log.w("MultipleQuestion",
